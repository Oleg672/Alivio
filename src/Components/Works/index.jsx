    ...
    return (
        <div className='container col-10 col-xl-8'>
            <section className="works row">
                ...
                <div className="works__title col-6">
                    <span>How it works</span>
                    <h2>Understand & Release the stress in 3 steps</h2>
                </div>

                <p className="works__description col-6">Alivio offers as many journals it takes, tackling different areas such as anxiety, overwhelmedness, sadness, or anger, and a variety of personal causes, to help you become aware of your emotions, and guide you in how to manage stress.</p>
