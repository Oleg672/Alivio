        ...
        <section className="works row">
            <div className='container col-10 col-xl-8'>
                <div className="inner row">
                    <div className="works__title col-12 .col-md-6 col-lg-5">
                        {/* <span>How it works</span> */}
                        <h2>Understand & Release the stress in 3 steps</h2>
                    </div>

                    <p className="works__description col-12 .col-md-6 col-lg-6">Alivio offers as many journals it takes, tackling different areas such as anxiety, overwhelmedness, sadness, or anger, and a variety of personal causes, to help you become aware of your emotions, and guide you in how to manage stress.</p>

                </div>

                <ul className="works__list row">
                    <li className="works__item col-12 col-lg-4">
